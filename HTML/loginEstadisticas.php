    ...
    <main class="container">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if ($result->num_rows === 0) {
                ...
                header("Location: /HTML/estadistic.php?nombre=" . urlencode($nombre) . "&id=" . urlencode($id));
                exit();
            }
        }
        ...
        <form method="post" class="div_label">
            ...
            <div class="container_btn">
                <input type="submit" value="Iniciar Sesión" class="btn btn-play" name="submit_iniciar">
            </div>
        </form>
